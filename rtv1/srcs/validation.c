...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/30 14:17:03 by oseitama          #+#    #+#             */
/*   Updated: 2023/01/30 14:33:49 by oseitama         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		line_valid(char *line)
{
	if (ft_strncmp("cam: ", line, 5) == 0)
		return (1);
	else if (ft_strncmp("light: ", line, 7) == 0)
		return (1);
	else if (ft_strncmp("sphere: ", line, 8) == 0)
		return (1);
	else if (ft_strncmp("cone: ", line, 6) == 0)
		return (1);
	else if (ft_strncmp("cylinder: ", line, 10) == 0)
		return (1);
	else if (ft_strncmp("plane: ", line, 7) == 0)
		return (1);
	else if (ft_strncmp("ambient: ", line, 9) == 0)
		return (1);
	return (0);
}
